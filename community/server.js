...
//  NOTE : 로그인
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, '../community/login/Login.html'));
});

// NOTE : 회원가입
app.get('/Signup', (req, res) => {
    res.sendFile(path.join(__dirname, '../community/login/Signup.html'));
});
...
app.get('/users/info-edit', (req, res) => {
    res.sendFile(
        path.join(__dirname, '../community/userInfo/editUserInfo.html'),
    );
});
...
app.get('/users/pwd-edit', (req, res) => {
    res.sendFile(
        path.join(__dirname, '../community/userInfo/editPassword.html'),
    );
});
